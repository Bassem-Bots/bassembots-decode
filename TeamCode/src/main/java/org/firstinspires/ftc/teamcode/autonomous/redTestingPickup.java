...
@Autonomous(name = "Red (**Testing**)", group = "Competition")
public class redTestingPickup extends LinearOpMode {
    ...
    private final Pose moveSide = new Pose(144-50,127, -Math.toRadians(0));
    private final Pose pickupPose = new Pose(144-20, 122, -Math.toRadians(0));

    // SHOOT: Ideally this is where your shooter aims best at the goal
    private final Pose shootPose = new Pose(132, 93, Math.toRadians(-115));
