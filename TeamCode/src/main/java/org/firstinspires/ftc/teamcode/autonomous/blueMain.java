...
@Autonomous(name = "BlueMain", group = "Competition")
public class blueMain extends LinearOpMode {
    ...
    private final Pose redSquare = new Pose(144-33,45, Math.toRadians(-270));
    private final Pose pickupPose = new Pose(144-33, 28, Math.toRadians(-270));
