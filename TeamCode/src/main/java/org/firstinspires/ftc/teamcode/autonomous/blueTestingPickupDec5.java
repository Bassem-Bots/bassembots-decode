...
public class blueTestingPickupDec5 extends LinearOpMode {
    ...
    private final Pose moveUp = new Pose(144-50, 45, Math.toRadians(0));
    private final Pose moveSide = new Pose(144-50,23, -Math.toRadians(0));
    private final Pose pickupPose = new Pose(144-10, 23, -Math.toRadians(0));
