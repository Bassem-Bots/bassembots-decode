...
@Autonomous(name = "Blue copy (DONT USE)", group = "Competition")
public class blueAllainceCopy extends LinearOpMode {
    ...
    private final Pose startPose = new Pose(135, 45 , Math.toRadians(0));
    private final Pose shootPose = new Pose(134, 52, Math.toRadians(87));
    private final Pose redSquare = new Pose(144-60,52, Math.toRadians(0));
    private final Pose moveSide = new Pose(144-60, 30, Math.toRadians(0));
    private final Pose pickupPose = new Pose(144-33, 30, Math.toRadians(0));
    private final Pose finalPose = new Pose(144-33, 98, Math.toRadians(0));
    ...
    private PathChain shootToPickup, pickupToShoot, shootToStart, shootToRed, redToSide, sideToPickup, shootToFinal;
    ...
    public void buildPaths() {
        ...
        redToSide = follower.pathBuilder()
                .addPath(new BezierLine(redSquare, moveSide))
                .setLinearHeadingInterpolation(redSquare.getHeading(), moveSide.getHeading())
                .build();
...
//            fireShots(3, .71f);
        ...
        follower.followPath(redToSide);
        driveUntilDone("Driving to Side");
