...
@Autonomous(name = "BlueNear", group = "Competition")
public class BlueAllianceNear extends LinearOpMode {
    ...
    private final Pose startPose = new Pose(20, 118.5 , Math.toRadians(-45));
    ...
    private final Pose shootPose = new Pose(72.65, 83, Math.toRadians(-45));
