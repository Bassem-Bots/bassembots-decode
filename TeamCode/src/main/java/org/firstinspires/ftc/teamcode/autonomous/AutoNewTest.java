...
public class AutoNewTest extends LinearOpMode {
    ...
    private final Pose finalPose = new Pose(39, 50, Math.toRadians(90));

    // SHOOT: Ideally this is where your shooter aims best at the goal
    private final Pose shootPose = new Pose(68, 36, Math.toRadians(90-15));
    ...
    private final Pose pickupPose = new Pose(20, 65, Math.toRadians(10));

    // Paths
    private Path startToShoot;
    private PathChain shootToPickup, pickupToShoot, shootToStart;
...
//        // Path 3: Drive from Pickup back to Shoot
    ...
    private void fireShots(int numberOfShots, float power) {
        ...
        sleep(3800); // Wait for flywheel to get to speed
        ...
        for (int i = 0; i < numberOfShots; i++) {
            ...
            if (i!=numberOfShots-1)sleep(3900);
...
//    // START: Assuming you start near the Backboard to shoot quickly
//    private final Pose startPose = new Pose(9, 60, Math.toRadians(180));
//    private final Pose finalPose = new Pose(29, 60, Math.toRadians(0));
//
//    // SHOOT: Ideally this is where your shooter aims best at the goal
//    private final Pose shootPose = new Pose(68, 36, Math.toRadians(90-15));
//    private final Pose shootPose2 = new Pose(115, 36, Math.toDegrees(-140+-25));
//
//    // PICKUP: Location of the balls on the floor (Spike Mark or Stack)
//    // Adjusted to be slightly away so we can drive *through* it or stop *at* it
//    private final Pose pickupPose = new Pose(20, 65, Math.toRadians(10));
...
//
//        shootToStart = follower.pathBuilder()
//                .addPath(new BezierLine(shootPose2, startPose))
//                .setLinearHeadingInterpolation(shootPose2.getHeading(), startPose.getHeading())
//                .build();
//    }
//
//    @Override
