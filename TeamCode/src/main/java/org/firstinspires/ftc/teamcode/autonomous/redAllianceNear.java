...
@Autonomous(name = "red near", group = "Competition")
public class redAllianceNear extends LinearOpMode {
...
//    private final Pose startPrimePose = new Pose(134, 93, Math.toRadians(0));
    ...
    private final Pose shootPose = new Pose(132, 93, Math.toRadians(-130));
